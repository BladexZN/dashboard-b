                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="pl-3">
                            ...
                            <h4 className="text-base font-bold text-white mb-1 leading-snug pr-2 select-none">{req.product}</h4>
                            <p className="text-sm text-muted-dark mb-5 truncate select-none">{req.client}</p>
